        ...
        <div class="container">
            <div class="mb-5">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="mb-0">Lorem ipsum dolor sit amet consectetur?</h2>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card card-discussions mb-5">
                        <div class="row">
                            <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                <a href="#">
                                    <img src="{{ url('assests/images/un-like.svg') }}" alt="un-like" class="like-icon mb-1">
                                </a>
                                <span class="fs-4 color-gray mb-1">12</span>
                            </div>
                            <div class="col-11">
                                <p>
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos fugiat consectetur delectus natus? Ea minima aspernatur reprehenderit vero excepturi necessitatibus voluptates dolore, inventore minus veritatis enim. Minima magnam quisquam quod.
                                </p>
                                <div class="mb-3">
                                ...
                                <div class="row align-items-start justify-content-between">
                                    ...
                                    <div class="col-5 col-lg-3 d-flex">
                                        <a href="#" class="card-discussions-show-avatar-wrapper flex-shrink-0 rounded-circle overflow-hidden me-1">
                                            <img src="{{ url('assests/images/ellipse-2.svg') }}" alt="" class="avatar">
                                        </a>
                    ...
                    <div class="mb-5">
                        <div class="card card-discussions">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam accusantium a nostrum possimus porro.
                                    </p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="card">
                        ...
                        <div>
                            <a href=""><span class="badge rounded-pill text-bg-light">lorem</span></a>
                            <a href=""><span class="badge rounded-pill text-bg-light">lorem</span></a>
                            <a href=""><span class="badge rounded-pill text-bg-light">lorem</span></a>
                        </div>
                    </div>
