                ...
                <div class="col-12 col-lg-4 mb-5 mb-lg-0">
                    <div class="d-flex mb-4">
                        <div class="avatar-wrapper rounded-circle overflow-hidden flex-shrink-0 me-4">
                            <img src="{{ url('assests/images/avatar-sm.svg') }}" alt="avatar" class="avatar">
                        </div>
                        <div>
                            <div class="mb-4">
                    ...
                    <div>
                        ...
                        <a id="share-profile" class="btn btn-primary me-4" href="javascrip:;">Share</a>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#share-profile').click(function() {
                ...
                alertContainer.first().text('Link to this profiles successfuly');
            });
        });
    </script>
@endsection